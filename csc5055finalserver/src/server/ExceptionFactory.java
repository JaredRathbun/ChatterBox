...
{    
    ...
    /**
     * Getter for a NoSuchUserException with no specific message.
     * 
     * @return A new NoSuchUserException with no specific message. 
     */
    public static final NoSuchUserException getNoSuchUserException()
    {
        return new NoSuchUserException();
    }
    
    /**
     * Getter for a NoSuchUserException with a specific message.
     * 
     * @param message The message to set on the exception.
     * @return A new NoSuchUserException with a specific message. 
     */
    public static final NoSuchUserException getNoSuchUserException(String 
            message)
    {
    ...
    * Due Date: May 11, 2021 @ 11:30am
    *
    * This exception serves as an exception for when the account's information
    * does not exist.
    * </pre>
    */
    protected static final class NoSuchUserException extends Exception
    {
        /**
         * Creates a new instance of <code>NoSuchUserException</code> without
         * detail message.
         */
